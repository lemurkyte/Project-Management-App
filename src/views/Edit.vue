  ...
  <div class="row justify-content-center">
    <div class="col-md-9">
      <div class="card card-body mt-4">
        <router-link :to="'/'" class="btn btn-primary" style="width: 80px;">Back</router-link>
        <h3>Edit Project</h3>
        <form @submit.prevent="update">
          ...
          <div class="form-group form-check">
            ...
            />
            <label for="taskCompletionStatus" class="form-check-label"
              >Completed</label
            >
          </div>
          <div class="form-group">
            <label for=""
              >Task Creation Date: {{ taskCreationDateAndTimeOfDay }}</label
            >
          </div>
